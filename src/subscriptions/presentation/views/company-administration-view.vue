      ...
      <section class="flow-panel span-7">
        <div class="flow-panel-head">
          <div>
            ...
            <div class="flow-subtitle">Demo-only access list. It does not create real authentication records.</div>
          </div>
          <button class="btn btn-secondary" disabled><i class="pi pi-user-plus"></i> Invite team member</button>
        </div>
