...
export const PORTAL_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'business-documents', loadComponent: () => import('./views/portal-documents.page').then((m) => m.PortalDocumentsPage) },
      { path: 'documents', pathMatch: 'full', redirectTo: 'business-documents' },
