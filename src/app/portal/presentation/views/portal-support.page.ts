...
export class PortalSupportPage {
  ...
  readonly supportCopy = computed(() => {
    ...
    return es ? {
      ...
      cards: [
        { icon: 'pi-inbox', title: 'Revision de solicitudes', copy: 'Usa Mis solicitudes para revisar comentarios de ventas, ajustes, validacion de credito y conversion a orden.', action: 'Abrir solicitudes', to: '/portal/purchase-requests' },
        ...
        { icon: 'pi-truck', title: 'Seguimiento de ordenes', copy: 'Usa Mis órdenes para revisar validacion, documentos, preparacion, ruta y evidencia de entrega.', action: 'Abrir ordenes', to: '/portal/purchase-orders' },
      ...
      notes: [
        ...
        ['Asistencia de cuenta', 'Usa Perfil para identidad, direcciones y notificaciones. Para problemas de acceso, cambia de cuenta e inicia sesion con un usuario autorizado.'],
      ],
    } : {
      pill: 'Support',
      title: 'Nexa Support',
