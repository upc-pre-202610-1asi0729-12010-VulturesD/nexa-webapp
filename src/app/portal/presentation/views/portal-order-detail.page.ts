          ...
          <div class="flow-grid-12">
            ...
            <aside class="flow-panel span-4">
              <div class="flow-panel-pad flow-stack">
                ...
                <a routerLink="/portal/purchase-orders" class="secondary-btn">{{ 'portal.nav.documents' | t }}</a>
              </div>
            </aside>
            <section class="flow-panel span-6">
              <div class="flow-panel-head">
                <div class="flow-title">{{ 'portal.detail.availableDocuments' | t }}</div>
                <a routerLink="/portal/purchase-orders" class="btn btn-ghost btn-sm">{{ 'portal.actions.viewAll' | t }}</a>
              </div>
