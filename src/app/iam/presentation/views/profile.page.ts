    ...
    <div class="page">
      <div class="page-header" role="banner">
        ...
        <div class="profile-account-actions">
          <button type="button" class="btn btn-secondary" (click)="endSession()">
            <i class="pi pi-users"></i> {{ 'profile.switchAccount' | t }}
          </button>
          <button type="button" class="btn btn-ghost" (click)="endSession()">
            <i class="pi pi-sign-out"></i> {{ 'common.logout' | t }}
          </button>
        </div>
      </div>
