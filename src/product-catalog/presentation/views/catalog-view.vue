...
<template>
  ...
  <div class="catalog-grid" role="list" :aria-label="t('nav.catalog')">
    <div
      ...
      role="button"
      tabindex="0"
      :aria-label="'View Details de ' + p.name"
      @click="openDetail(p)"
      ...
      <div class="card" style="max-width:540px;width:100%;overflow:hidden">
        ...
        <div style="padding:20px">
          <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:14px">
            ...
            <button class="btn btn-ghost btn-sm" @click="closeDetail" aria-label="Close"><i class="pi pi-times"></i></button>
          </div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:16px">
            <div style="background:#F9FAFB;border-radius:8px;padding:10px">
              <div style="font-size:10px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Temperature</div>
            ...
            <div style="background:#F9FAFB;border-radius:8px;padding:10px">
              <div style="font-size:10px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Unit</div>
              <div style="font-size:13px;font-weight:500">{{ detail.unit }}</div>
            </div>
            <div style="background:#F9FAFB;border-radius:8px;padding:10px">
              <div style="font-size:10px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Available Stock</div>
            ...
            <div style="background:#F9FAFB;border-radius:8px;padding:10px">
              <div style="font-size:10px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Price</div>
              <div style="font-size:16px;font-weight:700;font-family:'Plus Jakarta Sans',sans-serif">S/ {{ detail.price.toFixed(2) }}</div>
            </div>
            <div style="background:#F9FAFB;border-radius:8px;padding:10px">
              <div style="font-size:10px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Warehouse</div>
              <div style="font-size:13px;font-weight:500">{{ detail.warehouse }} / {{ detail.zone }}</div>
            </div>
            <div style="background:#F9FAFB;border-radius:8px;padding:10px">
              <div style="font-size:10px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Status</div>
